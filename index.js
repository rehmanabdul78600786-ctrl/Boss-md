...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there 𝘽𝙊𝙎𝙎-𝙈𝘿 User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet 𝐵𝒪𝒮𝒮-𝑀𝒟 WhatsApp Bot.\n\n *Thanks for using 𝘽𝙊𝙎𝙎-𝙈𝘿 \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VbC210i2P59dHYVlXW1K \n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Boss-MD-BOTZ/Boss-Ai\n\n> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝘽𝙊𝙎𝙎-𝙈𝘿 ❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/28y8ok.jpg` }, caption: up })
  }
  })
...
//============================== 
  ...
  const groupName = isGroup ? await conn.groupMetadata(from).then(m => m.subject || 'Group').catch(e => 'Group') : '';
